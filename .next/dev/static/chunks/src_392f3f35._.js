...
const ProductDetail = ()=>{
    ...
    const id = params?.id;
    const product = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$demo$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].find((p)=>p.id === id);
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const { addToWishlist, isInWishlist, removeFromWishlist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$WishlistContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWishlist"])();
    ...
    const relatedProducts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$demo$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].filter((p)=>p.category === product.category && p.id !== product.id).slice(0, 4);
    const inWishlist = isInWishlist(product.id);
    const handleAddToCart = ()=>{
...
_s(ProductDetail, "nsGZAlvceKe7TD46X7qBgtDYjHw=", false, function() {
    return [
...
//# sourceMappingURL=src_392f3f35._.js.map