    ...
    <div className="w-full p-4" suppressHydrationWarning>
      <div className="grid grid-cols-12 gap-4">
              ...
              return (
                <div key={category.id} className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-accent group-hover:bg-accent/80 transition-all duration-200">
        ...
        <div className="col-span-4 space-y-2">
          {featuredCategories.slice(0, 2).map((category, idx) => (
            <Link
              key={category.id}
              href={`/categories/${createCategorySlug(category.name)}`}
